...
var _handlingImage = require("./handlingImage.js");
// @ts-nocheck

var authorPhotoEl = document.querySelector('.author-photo');
var authorNameEl = document.querySelector('.author-name');
var authorQuoteEl = document.querySelector('.author-quote');
...
function displayQuote(obj) {
  (0, _handlingImage.handlingImage)(obj, authorPhotoEl);
  authorNameEl.textContent = obj.author;
  authorQuoteEl.innerHTML = obj.quote;
}

},{"./handlingImage.js":2}],2:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.handlingImage = handlingImage;
// @ts-nocheck
...
function handlingImage(obj, el) {
  ...
  image.addEventListener('load', function () {
    obj.photo === '' ? (el.src = 'img/no-photo.png', el.alt = 'No photo available') : (el.src = obj.photo, el.alt = "".concat(obj.author, "'s photo"));
  });
...
var _displayQuote = require("./modules/displayQuote.js");
...
var API_URL = 'https://thatsthespir.it/api';
...
function _getQuote() {
  _getQuote = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var res, data;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 8:
          data = _context.sent;
          (0, _displayQuote.displayQuote)(data);
          _context.next = 15;
          break;
        case 12:
          _context.prev = 12;
          _context.t0 = _context["catch"](0);
          console.error('Error fetching or processing quote:', _context.t0);
        case 15:
        case "end":
